<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Mvc3.SignInModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <h2>Sign in</h2>
        <p>Sign in with your App Shop account. Don't have an account yet? <%: Html.ActionLink("Sign up", "SignUp") %> for one.</p>
