<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SignIn.aspx.cs" Inherits="ASP.NET.SignIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" id="content">
        ...
        <h2>Sign in</h2>
        <p>Sign in with your App Shop account. Don't have an account yet? <a href="/Account/SignUp.aspx">Sign up</a> for one.</p>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server"
                            TargetControlID="TextBoxEmail" WatermarkText="Email" WatermarkCssClass="watermarked" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
